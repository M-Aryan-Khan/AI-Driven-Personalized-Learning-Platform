...
export default function MessagesPage() {
  ...
  const mockConversations: Conversation[] = [
    {
      ...
      expert_id: "exp1",
      expert_name: "Aryan K.",
      expert_profile_image: undefined,
      last_message: "Okay no worries",
  ...
  useEffect(() => {
    ...
    if (expertParam) {
      // If expert param exists, set the selected conversation
      const expert = {
        id: "exp1",
        name: "Aryan K.",
  ...
  const handleSelectConversation = (conversation: Conversation) => {
    ...
    setSelectedExpert({
      ...
      name: conversation.expert_name,
      profile_image: conversation.expert_profile_image,
    })
  }
    ...
    <div className="container mx-auto max-w-6xl">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                {loading ? (
                  ...
                  <div className="p-6 text-center">
                    ...
                    <Button
                      ...
                      onClick={() => (window.location.href = "/dashboard/student/find-tutors")}
                    >
                      Find tutors
                    </Button>
                  </div>
                      ...
                      >
                        <div className="flex gap-3">
                          <Avatar className="h-12 w-12">
                            <AvatarImage
                              src={conversation.expert_profile_image || "/placeholder.svg"}
                              alt={conversation.expert_name}
                            />
                          ...
                          <div className="flex-1 overflow-hidden">
                            <div className="flex justify-between">
                              <h3 className="truncate text-deep-cocoa">{conversation.expert_name}</h3>
        ...
        <Card className="flex h-[600px] flex-col md:col-span-2">
          {selectedConversation && selectedExpert ? (
            <>
              <div className="flex items-center gap-3 border-b p-4">
                <Avatar className="h-10 w-10">
                  <AvatarImage src={selectedExpert.profile_image || "/placeholder.svg"} alt={selectedExpert.name} />
                  <AvatarFallback className="bg-[#ffc6a8] text-deep-cocoa">
                    {selectedExpert.name
                      .split(" ")
                      .map((n) => n[0])
                ...
                <div>
                  <h3 className="font-semibold text-deep-cocoa">{selectedExpert.name}</h3>
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-4">
                <div className="space-y-4">
                  {messages.map((message) => {
                    const isCurrentUser = message.sender_role === "student"
            ...
            <div className="flex h-full flex-col items-center justify-center p-6 text-center">
              ...
              <p className="mb-6 text-gray-500">
                Choose a conversation from the list or start a new one by finding a tutor.
              </p>
              <Button
                className="bg-[#ffc6a8] text-deep-cocoa hover:bg-[#ffb289]"
                onClick={() => (window.location.href = "/dashboard/student/find-tutors")}
