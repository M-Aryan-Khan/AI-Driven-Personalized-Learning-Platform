    ...
    >
      <div className="flex items-center justify-between h-16 px-4 border-b border-rose-dust/20 dark:border-rose-dust/10">
        ...
        <button
          ...
          className="p-2 rounded-md cursor-pointer hover:bg-soft-peach dark:hover:bg-warm-coral/20"
        >
          {collapsed ? (
            ...
            <svg
              ...
              className="text-deep-cocoa dark:text-vanilla-cream"
            >
        ...
        {items.map((item, index) => (
          <Link
            ...
            className={cn(
              ...
              pathname === item.href
                ? "bg-soft-peach text-deep-cocoa dark:bg-warm-coral/20 dark:text-vanilla-cream"
                : "text-deep-cocoa/70 hover:bg-soft-peach/50 dark:text-vanilla-cream/70 dark:hover:bg-warm-coral/10",
